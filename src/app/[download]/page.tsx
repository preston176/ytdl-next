...
export default function DownloadPage() {
    ...
    const [resolution, setResolution] = useState<string>(''); // Changed from object[] to string
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const options = {
                method: 'GET',
                headers: {
                    'x-rapidapi-key': process.env.RAPID_API_KEY as string, // Use environment variable
                ...
                {videoData && (
                    <div className="flex flex-col md:flex-row items-center mb-8">
                        <div className="flex-1 mb-4 md:mb-0 md:mr-4 flex justify-center">
                            <Image
                                src={videoData.thumbnail[0].url} // Adjusted index to 0 assuming the first thumbnail is used
                                alt={videoData.title}
                                width={400}
                                height={225}
